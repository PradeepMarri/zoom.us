...
func ListpastwebinarpollresultsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/past_webinars/%s/polls%s", cfg.BaseURL, webinarId, queryString)
...
func CreateListpastwebinarpollresultsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_past_webinars_webinarId_polls",
		mcp.WithDescription("List past webinar poll results"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListpastwebinarpollresultsHandler(cfg),
	}
}
