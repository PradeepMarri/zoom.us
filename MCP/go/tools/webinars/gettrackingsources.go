...
func GettrackingsourcesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/webinars/%s/tracking_sources%s", cfg.BaseURL, webinarId, queryString)
...
func CreateGettrackingsourcesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webinars_webinarId_tracking_sources",
		mcp.WithDescription("Get webinar tracking sources"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GettrackingsourcesHandler(cfg),
	}
}
