...
func WebinarregistrantsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		if val, ok := args["tracking_source_id"]; ok {
			queryParams = append(queryParams, fmt.Sprintf("tracking_source_id=%v", val))
		}
...
func CreateWebinarregistrantsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webinars_webinarId_registrants",
		mcp.WithDescription("List webinar registrants"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarregistrantsHandler(cfg),
	}
}
