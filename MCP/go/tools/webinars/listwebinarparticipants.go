...
func ListwebinarparticipantsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/past_webinars/%s/participants%s", cfg.BaseURL, webinarId, queryString)
...
func CreateListwebinarparticipantsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_past_webinars_webinarId_participants",
		mcp.WithDescription("List webinar participants"),
		mcp.WithString("webinarId", mcp.Required(), mcp.Description("Unique identifier of the webinar. You can retrieve the value of this field by calling the [list webinars](https://marketplace.zoom.us/docs/api-reference/zoom-api/webinars/webinars) API.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListwebinarparticipantsHandler(cfg),
	}
}
