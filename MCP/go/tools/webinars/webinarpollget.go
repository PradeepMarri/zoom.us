...
func WebinarpollgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateWebinarpollgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webinars_webinarId_polls_pollId",
		mcp.WithDescription("Get a webinar poll"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarpollgetHandler(cfg),
	}
}
