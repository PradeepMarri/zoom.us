...
func WebinarpanelistsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateWebinarpanelistsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_webinars_webinarId_panelists",
		mcp.WithDescription("Remove panelists"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarpanelistsdeleteHandler(cfg),
	}
}
