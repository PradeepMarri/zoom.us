...
func WebinarsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateWebinarsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_userId_webinars",
