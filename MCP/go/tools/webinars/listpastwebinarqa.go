...
func ListpastwebinarqaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/past_webinars/%s/qa%s", cfg.BaseURL, webinarId, queryString)
...
func CreateListpastwebinarqaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_past_webinars_webinarId_qa",
		mcp.WithDescription("List Q&A of past webinar"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListpastwebinarqaHandler(cfg),
	}
}
