...
func WebinarpanelistcreateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/webinars/%s/panelists%s", cfg.BaseURL, webinarId, queryString)
...
func CreateWebinarpanelistcreateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_webinars_webinarId_panelists",
		mcp.WithDescription("Add panelists"),
		...
		mcp.WithArray("panelists", mcp.Description("Input parameter: List of panelist objects.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    WebinarpanelistcreateHandler(cfg),
	}
}
