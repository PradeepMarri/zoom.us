...
func WebinarpanelistsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateWebinarpanelistsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webinars_webinarId_panelists",
		mcp.WithDescription("List panelists"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarpanelistsHandler(cfg),
	}
}
