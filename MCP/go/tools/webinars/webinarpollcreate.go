...
func WebinarpollcreateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/webinars/%s/polls%s", cfg.BaseURL, webinarId, queryString)
...
func CreateWebinarpollcreateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_webinars_webinarId_polls",
		mcp.WithDescription("Create a webinar's poll"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarpollcreateHandler(cfg),
	}
}
