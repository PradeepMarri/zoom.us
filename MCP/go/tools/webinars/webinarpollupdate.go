...
func WebinarpollupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateWebinarpollupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_webinars_webinarId_polls_pollId",
		mcp.WithDescription("Update a webinar poll"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarpollupdateHandler(cfg),
	}
}
