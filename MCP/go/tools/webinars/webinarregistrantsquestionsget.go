...
func WebinarregistrantsquestionsgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateWebinarregistrantsquestionsgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webinars_webinarId_registrants_questions",
		mcp.WithDescription("List registration questions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarregistrantsquestionsgetHandler(cfg),
	}
}
