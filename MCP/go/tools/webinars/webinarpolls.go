...
func WebinarpollsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateWebinarpollsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webinars_webinarId_polls",
		mcp.WithDescription("List a webinar's polls "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    WebinarpollsHandler(cfg),
	}
}
