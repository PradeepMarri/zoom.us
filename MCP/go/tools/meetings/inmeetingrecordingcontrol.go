...
func InmeetingrecordingcontrolHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/live_meetings/%s/events%s", cfg.BaseURL, meetingId, queryString)
...
func CreateInmeetingrecordingcontrolTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_live_meetings_meetingId_events",
		mcp.WithDescription("Use in-Meeting recording controls"),
		mcp.WithString("meetingId", mcp.Required(), mcp.Description("Unique identifier of the live meeting.")),
		mcp.WithString("method", mcp.Description("Input parameter: The method that you would like to control. The value of this field can be one of the following:\n* `recording.start`: Provide this value if you would like to start the recording.<br><br>\n* `recording.stop`: Provide this value if you would like to stop the recording.<br><br>\n* `recording.pause`: Provide this value if you would like to pause the recording.<br><br>\n* `recording.resume`: Provide this value if you would like to resume the recording that was previously paused.\n\n\n\n")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    InmeetingrecordingcontrolHandler(cfg),
	}
}
