...
func MeetinginvitationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/meetings/%s/invitation%s", cfg.BaseURL, meetingId, queryString)
...
func CreateMeetinginvitationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_meetings_meetingId_invitation",
		mcp.WithDescription("Get meeting invitation"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetinginvitationHandler(cfg),
	}
}
