...
func MeetingpollsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateMeetingpollsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_meetings_meetingId_polls",
		mcp.WithDescription("List meeting polls"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetingpollsHandler(cfg),
	}
}
