...
func MeetingregistrantsquestionsgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateMeetingregistrantsquestionsgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_meetings_meetingId_registrants_questions",
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetingregistrantsquestionsgetHandler(cfg),
	}
}
