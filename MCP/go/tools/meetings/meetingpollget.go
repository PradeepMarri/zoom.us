...
func MeetingpollgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateMeetingpollgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_meetings_meetingId_polls_pollId",
		mcp.WithDescription("Get a meeting poll"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetingpollgetHandler(cfg),
	}
}
