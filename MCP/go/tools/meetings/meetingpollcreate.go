...
func MeetingpollcreateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/meetings/%s/polls%s", cfg.BaseURL, meetingId, queryString)
...
func CreateMeetingpollcreateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_meetings_meetingId_polls",
		mcp.WithDescription("Create a meeting poll"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetingpollcreateHandler(cfg),
	}
}
