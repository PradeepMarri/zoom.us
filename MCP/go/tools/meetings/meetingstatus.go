...
func MeetingstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/meetings/%s/status%s", cfg.BaseURL, meetingId, queryString)
...
func CreateMeetingstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_meetings_meetingId_status",
		mcp.WithDescription("Update meeting status"),
