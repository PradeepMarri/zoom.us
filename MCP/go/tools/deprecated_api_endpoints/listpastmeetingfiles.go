...
func ListpastmeetingfilesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/past_meetings/%s/files%s", cfg.BaseURL, meetingId, queryString)
...
func CreateListpastmeetingfilesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_past_meetings_meetingId_files",
		mcp.WithDescription("List past meeting's files"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListpastmeetingfilesHandler(cfg),
	}
}
