...
func AccountmanageddomainHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounts/%s/managed_domains%s", cfg.BaseURL, accountId, queryString)
...
func CreateAccountmanageddomainTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounts_accountId_managed_domains",
		mcp.WithDescription("Get managed domains"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AccountmanageddomainHandler(cfg),
	}
}
