...
func UpdateaccountlocksettingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdateaccountlocksettingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_accounts_accountId_lock_settings",
		mcp.WithDescription("Update locked settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateaccountlocksettingsHandler(cfg),
	}
}
