...
func AccountsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateAccountsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounts",
		mcp.WithDescription("List sub accounts"),
