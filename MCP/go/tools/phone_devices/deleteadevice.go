...
func DeleteadeviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteadeviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_phone_devices_deviceId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteadeviceHandler(cfg),
	}
}
