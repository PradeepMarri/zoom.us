...
func GetadeviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetadeviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_phone_devices_deviceId",
