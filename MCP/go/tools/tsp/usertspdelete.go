...
func UsertspdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsertspdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_users_userId_tsp_tspId",
		mcp.WithDescription("Delete a user's TSP account"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UsertspdeleteHandler(cfg),
	}
}
