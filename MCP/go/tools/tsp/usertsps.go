...
func UsertspsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsertspsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_userId_tsp",
		mcp.WithDescription("List user's TSP accounts"),
