...
func UsertspHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsertspTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_userId_tsp_tspId",
		mcp.WithDescription("Get a user's TSP account"),
