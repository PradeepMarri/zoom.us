...
func ListblockedlistHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListblockedlistTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_phone_blocked_list",
		mcp.WithDescription("List blocked lists"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListblockedlistHandler(cfg),
	}
}
