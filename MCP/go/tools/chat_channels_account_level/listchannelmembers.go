...
func ListchannelmembersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListchannelmembersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_chat_users_userId_channels_channelId_members",
		mcp.WithDescription("List channel members"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListchannelmembersHandler(cfg),
	}
}
