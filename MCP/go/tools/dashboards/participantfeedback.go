...
func ParticipantfeedbackHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/meetings/%s/participants/satisfaction%s", cfg.BaseURL, meetingId, queryString)
...
func CreateParticipantfeedbackTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_meetings_meetingId_participants_satisfaction",
		mcp.WithDescription("Get post meeting feedback"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ParticipantfeedbackHandler(cfg),
	}
}
