...
func DashboardmeetingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/meetings%s", cfg.BaseURL, queryString)
...
func CreateDashboardmeetingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_meetings",
		...
		mcp.WithString("include_fields", mcp.Description("Set the value of this field to \"tracking_fields\" if you would like to include tracking fields of each meeting in the response.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DashboardmeetingsHandler(cfg),
	}
}
