...
func DashboardimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/im%s", cfg.BaseURL, queryString)
...
func CreateDashboardimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_im",
		mcp.WithDescription("Get IM metrics"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DashboardimHandler(cfg),
	}
}
