...
func DashboardwebinarsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/webinars%s", cfg.BaseURL, queryString)
...
func CreateDashboardwebinarsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_webinars",
		mcp.WithDescription("List webinars"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DashboardwebinarsHandler(cfg),
	}
}
