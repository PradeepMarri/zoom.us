...
func DashboardzoomroomsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/zoomrooms%s", cfg.BaseURL, queryString)
...
func CreateDashboardzoomroomsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_zoomrooms",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DashboardzoomroomsHandler(cfg),
	}
}
