...
func DashboardwebinarparticipantsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/webinars/%s/participants%s", cfg.BaseURL, webinarId, queryString)
...
func CreateDashboardwebinarparticipantsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_webinars_webinarId_participants",
		mcp.WithDescription("Get webinar participants"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DashboardwebinarparticipantsHandler(cfg),
	}
}
