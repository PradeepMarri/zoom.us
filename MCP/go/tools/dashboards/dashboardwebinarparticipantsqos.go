...
func DashboardwebinarparticipantsqosHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/webinars/%s/participants/qos%s", cfg.BaseURL, webinarId, queryString)
...
func CreateDashboardwebinarparticipantsqosTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_webinars_webinarId_participants_qos",
		mcp.WithDescription("List webinar participant QoS"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DashboardwebinarparticipantsqosHandler(cfg),
	}
}
