...
func DashboardwebinarparticipantshareHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/webinars/%s/participants/sharing%s", cfg.BaseURL, webinarId, queryString)
...
func CreateDashboardwebinarparticipantshareTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_webinars_webinarId_participants_sharing",
	...
	return models.Tool{
		Definition: tool,
		Handler:    DashboardwebinarparticipantshareHandler(cfg),
	}
}
