...
func DashboardwebinardetailHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/metrics/webinars/%s%s", cfg.BaseURL, webinarId, queryString)
...
func CreateDashboardwebinardetailTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_metrics_webinars_webinarId",
		mcp.WithDescription("Get webinar details"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DashboardwebinardetailHandler(cfg),
	}
}
