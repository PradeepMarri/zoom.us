...
func ReportmeetingparticipantsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/report/meetings/%s/participants%s", cfg.BaseURL, meetingId, queryString)
...
func CreateReportmeetingparticipantsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_report_meetings_meetingId_participants",
		mcp.WithDescription("Get meeting participant reports"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReportmeetingparticipantsHandler(cfg),
	}
}
