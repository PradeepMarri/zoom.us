...
func ReportwebinardetailsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/report/webinars/%s%s", cfg.BaseURL, webinarId, queryString)
...
func CreateReportwebinardetailsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_report_webinars_webinarId",
		mcp.WithDescription("Get webinar detail reports"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReportwebinardetailsHandler(cfg),
	}
}
