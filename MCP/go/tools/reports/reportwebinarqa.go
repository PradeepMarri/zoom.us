...
func ReportwebinarqaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/report/webinars/%s/qa%s", cfg.BaseURL, webinarId, queryString)
...
func CreateReportwebinarqaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_report_webinars_webinarId_qa",
		mcp.WithDescription("Get webinar Q&A report"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReportwebinarqaHandler(cfg),
	}
}
