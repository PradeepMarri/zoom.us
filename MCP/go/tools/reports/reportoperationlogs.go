...
func ReportoperationlogsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/report/operationlogs%s", cfg.BaseURL, queryString)
...
func CreateReportoperationlogsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_report_operationlogs",
