...
func ReportwebinarpollsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/report/webinars/%s/polls%s", cfg.BaseURL, webinarId, queryString)
...
func CreateReportwebinarpollsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_report_webinars_webinarId_polls",
		mcp.WithDescription("Get webinar poll reports"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ReportwebinarpollsHandler(cfg),
	}
}
