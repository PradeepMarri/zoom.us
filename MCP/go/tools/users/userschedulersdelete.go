...
func UserschedulersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/%s/schedulers%s", cfg.BaseURL, userId, queryString)
...
func CreateUserschedulersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_users_userId_schedulers",
		mcp.WithDescription("Delete user schedulers"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UserschedulersdeleteHandler(cfg),
	}
}
