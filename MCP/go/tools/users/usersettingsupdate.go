...
func UsersettingsupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUsersettingsupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_users_userId_settings",
		mcp.WithDescription("Update user settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UsersettingsupdateHandler(cfg),
	}
}
