...
func UserpasswordHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/%s/password%s", cfg.BaseURL, userId, queryString)
...
func CreateUserpasswordTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_users_userId_password",
		mcp.WithDescription("Update a user's password"),
