...
func UserassistantsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUserassistantsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_userId_assistants",
		mcp.WithDescription("List user assistants"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UserassistantsHandler(cfg),
	}
}
