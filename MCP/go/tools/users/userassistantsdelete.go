...
func UserassistantsdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUserassistantsdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_users_userId_assistants",
		mcp.WithDescription("Delete user assistants"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UserassistantsdeleteHandler(cfg),
	}
}
