...
func UserschedulersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUserschedulersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_userId_schedulers",
		mcp.WithDescription("List user schedulers"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UserschedulersHandler(cfg),
	}
}
