...
func UserpermissionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/%s/permissions%s", cfg.BaseURL, userId, queryString)
...
func CreateUserpermissionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_userId_permissions",
		mcp.WithDescription("Get user permissions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UserpermissionHandler(cfg),
	}
}
