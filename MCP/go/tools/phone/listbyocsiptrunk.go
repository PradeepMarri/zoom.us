...
func ListbyocsiptrunkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/phone/sip_trunk/trunks%s", cfg.BaseURL, queryString)
...
func CreateListbyocsiptrunkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_phone_sip_trunk_trunks",
		mcp.WithDescription("List BYOC SIP trunks"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListbyocsiptrunkHandler(cfg),
	}
}
