...
func PhoneuserHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/phone/users/%s%s", cfg.BaseURL, userId, queryString)
...
func CreatePhoneuserTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_phone_users_userId",
		mcp.WithDescription("Get user's profile"),
