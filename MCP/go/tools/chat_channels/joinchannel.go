...
func JoinchannelHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateJoinchannelTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_chat_channels_channelId_members_me",
	...
	return models.Tool{
		Definition: tool,
		Handler:    JoinchannelHandler(cfg),
	}
}
