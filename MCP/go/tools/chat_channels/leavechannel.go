...
func LeavechannelHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/chat/channels/%s/members/me%s", cfg.BaseURL, channelId, queryString)
...
func CreateLeavechannelTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_chat_channels_channelId_members_me",
	...
	return models.Tool{
		Definition: tool,
		Handler:    LeavechannelHandler(cfg),
	}
}
