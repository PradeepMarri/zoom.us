...
func RemoveauserlevelchannelmemberHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/chat/channels/%s/members/%s%s", cfg.BaseURL, channelId, memberId, queryString)
...
func CreateRemoveauserlevelchannelmemberTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_chat_channels_channelId_members_memberId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    RemoveauserlevelchannelmemberHandler(cfg),
	}
}
