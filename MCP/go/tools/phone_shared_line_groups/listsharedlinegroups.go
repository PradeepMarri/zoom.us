...
func ListsharedlinegroupsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/phone/shared_line_groups%s", cfg.BaseURL, queryString)
...
func CreateListsharedlinegroupsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_phone_shared_line_groups",
		mcp.WithDescription("List shared line groups"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListsharedlinegroupsHandler(cfg),
	}
}
