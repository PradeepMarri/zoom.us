...
func ImgroupmembersHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/im/groups/%s/members%s", cfg.BaseURL, groupId, queryString)
...
func CreateImgroupmembersTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_im_groups_groupId_members",
		mcp.WithDescription("List IM directory group members"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ImgroupmembersHandler(cfg),
	}
}
