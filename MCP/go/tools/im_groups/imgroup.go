...
func ImgroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateImgroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_im_groups_groupId",
		mcp.WithDescription("Retrieve an IM directory group"),
		mcp.WithString("groupId", mcp.Required(), mcp.Description("The group ID.<br>\nCan be retrieved by calling [GET /groups](https://marketplace.zoom.us/docs/api-reference/zoom-api/groups/groups).")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    ImgroupHandler(cfg),
	}
}
