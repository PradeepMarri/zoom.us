...
func RecordingdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRecordingdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_meetings_meetingId_recordings",
		mcp.WithDescription("Delete meeting recordings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RecordingdeleteHandler(cfg),
	}
}
