...
func RecordingregistrantsquestionsgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRecordingregistrantsquestionsgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_meetings_meetingId_recordings_registrants_questions",
		mcp.WithDescription("Get registration questions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RecordingregistrantsquestionsgetHandler(cfg),
	}
}
