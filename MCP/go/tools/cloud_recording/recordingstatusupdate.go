...
func RecordingstatusupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/meetings/%s/recordings/status%s", cfg.BaseURL, meetingId, queryString)
...
func CreateRecordingstatusupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_meetings_meetingId_recordings_status",
		mcp.WithDescription("Recover meeting recordings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    RecordingstatusupdateHandler(cfg),
	}
}
