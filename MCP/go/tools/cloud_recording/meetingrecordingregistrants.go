...
func MeetingrecordingregistrantsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateMeetingrecordingregistrantsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_meetings_meetingId_recordings_registrants",
		mcp.WithDescription("List recording registrants"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetingrecordingregistrantsHandler(cfg),
	}
}
