...
func MeetingrecordingregistrantcreateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/meetings/%s/recordings/registrants%s", cfg.BaseURL, meetingId, queryString)
...
func CreateMeetingrecordingregistrantcreateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_meetings_meetingId_recordings_registrants",
		mcp.WithDescription("Create a recording registrant"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetingrecordingregistrantcreateHandler(cfg),
	}
}
