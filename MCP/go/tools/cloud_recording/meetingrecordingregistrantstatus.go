...
func MeetingrecordingregistrantstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/meetings/%s/recordings/registrants/status%s", cfg.BaseURL, meetingId, queryString)
...
func CreateMeetingrecordingregistrantstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_meetings_meetingId_recordings_registrants_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    MeetingrecordingregistrantstatusHandler(cfg),
	}
}
