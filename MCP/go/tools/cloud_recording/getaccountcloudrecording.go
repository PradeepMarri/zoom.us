...
func GetaccountcloudrecordingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/accounts/%s/recordings%s", cfg.BaseURL, accountId, queryString)
...
func CreateGetaccountcloudrecordingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_accounts_accountId_recordings",
		mcp.WithDescription("List recordings of an account"),
