...
func UserpacsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/users/%s/pac%s", cfg.BaseURL, userId, queryString)
...
func CreateUserpacsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_users_userId_pac",
		mcp.WithDescription("List a user's PAC accounts"),
