...
func GetgroupsettingsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/groups/%s/settings%s", cfg.BaseURL, queryString)
...
func CreateGetgroupsettingsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_groups_groupId_settings",
		mcp.WithDescription("Get a group's settings"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetgroupsettingsHandler(cfg),
	}
}
