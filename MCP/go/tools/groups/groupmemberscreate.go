...
func GroupmemberscreateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/groups/%s/members%s", cfg.BaseURL, groupId, queryString)
...
func CreateGroupmemberscreateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_groups_groupId_members",
		mcp.WithDescription("Add group members"),
		mcp.WithString("groupId", mcp.Required(), mcp.Description("The group ID.<br>\nCan be retrieved by calling [GET /groups](https://marketplace.zoom.us/docs/api-reference/zoom-api/groups/groups).")),
		mcp.WithArray("members", mcp.Description("Input parameter: List of Group members")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GroupmemberscreateHandler(cfg),
	}
}
