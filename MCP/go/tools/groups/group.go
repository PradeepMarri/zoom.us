...
func GroupHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGroupTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_groups_groupId",
		mcp.WithDescription("Get a group"),
