...
func GroupdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGroupdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_groups_groupId",
	...
	return models.Tool{
		Definition: tool,
		Handler:    GroupdeleteHandler(cfg),
	}
}
