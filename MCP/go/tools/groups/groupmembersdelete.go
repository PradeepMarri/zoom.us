...
func GroupmembersdeleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGroupmembersdeleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_groups_groupId_members_memberId",
		mcp.WithDescription("Delete a group member"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GroupmembersdeleteHandler(cfg),
	}
}
