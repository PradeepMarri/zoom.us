...
func ImchatsessionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/im/chat/sessions%s", cfg.BaseURL, queryString)
...
func CreateImchatsessionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_im_chat_sessions",
		mcp.WithDescription("Get IM chat sessions"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ImchatsessionsHandler(cfg),
	}
}
