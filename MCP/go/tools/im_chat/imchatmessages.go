...
func ImchatmessagesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/im/chat/sessions/%s%s", cfg.BaseURL, sessionId, queryString)
...
func CreateImchatmessagesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_im_chat_sessions_sessionId",
		mcp.WithDescription("Get IM chat messages"),
		mcp.WithString("sessionId", mcp.Required(), mcp.Description("IM chat session ID.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ImchatmessagesHandler(cfg),
	}
}
