...
func ListphonesitesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListphonesitesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_phone_sites",
		mcp.WithDescription("List phone sites"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    ListphonesitesHandler(cfg),
	}
}
